...
PhotoDedup follows SemVer and keeps completed work separate from future milestones.
...
| 1.0.12 | Released | Full/Lite release policy, installer coherence, AI UI gating, and smoke workflow fixes. |
| 1.0.6 - 1.0.11 | Released | `src/` architecture migration, dual-build automation, and packaging reliability improvements. |
| 1.0.0 - 1.0.5 | Released | Initial duplicate detection, installers, PyInstaller release assets, and onefile distribution. |
...
- Cloud upload, remote photo scanning, or account-based sync.
- Permanent deletion as the default duplicate action.
- Requiring AI dependencies in the Lite edition.
